...
module.exports = {
  ...
  //   const chance = new Chance() // Random Generator
  //   const name = chance.name().split(' ')
  //   user.firstName = name[0]
  //   user.lastName = name[1]
  //   user.username = name[0].toLowerCase() + chance.integer({ min: 0, max: 100000 })
  ...
  // },
  // 'register page renders elemenst': function (browser) {
